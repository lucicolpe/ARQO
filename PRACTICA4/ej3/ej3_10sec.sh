...
echo $SERIE >> time10.tab
echo ${PAR1[1]}"	"${PAR1[2]}"	"${PAR1[3]}"	"${PAR1[4]} >> time10.tab
echo ${PAR2[1]}"	"${PAR2[2]}"	"${PAR2[3]}"	"${PAR2[4]} >> time10.tab
echo ${PAR3[1]}"	"${PAR3[2]}"	"${PAR3[3]}"	"${PAR3[4]} >> time10.tab
...
echo 1 >> acc10.tab
echo ${ACC1[1]}"	"${ACC1[2]}"	"${ACC1[3]}"	"${ACC1[4]} >> acc10.tab
echo ${ACC2[1]}"	"${ACC2[2]}"	"${ACC2[3]}"	"${ACC2[4]} >> acc10.tab
echo ${ACC3[1]}"	"${ACC3[2]}"	"${ACC3[3]}"	"${ACC3[4]} >> acc10.tab
